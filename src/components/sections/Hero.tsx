        ...
        <div>
          ...
          >
            ...
            <span style={{ display: "block", fontSize: "0.72em", marginTop: "0.28em" }}>
              <span style={{ color: "#FBE6BD", WebkitTextStroke: "0.5px #A66E12", paintOrder: "stroke fill" }}>Taught by </span>
              <span style={{ color: "#F4CFCF", WebkitTextStroke: "0.5px #923333", paintOrder: "stroke fill" }}>Band 6 </span>
              <span style={{ color: "#CFEAD9", WebkitTextStroke: "0.5px #1F6B40", paintOrder: "stroke fill" }}>Graduates</span>
            </span>
          </h1>
