...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${SITE_URL}/hsc-business-studies-tutor-sydney`,            lastModified: new Date(), changeFrequency: "monthly", priority: 0.95 },
    { url: `${SITE_URL}/hsc-business-studies-tutor-parramatta`,        lastModified: new Date(), changeFrequency: "monthly", priority: 0.9  },
