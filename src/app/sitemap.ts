...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${SITE_URL}/notes/operations`,                            lastModified: new Date("2026-05-06"), changeFrequency: "monthly", priority: 0.8  },
    { url: `${SITE_URL}/notes/band-6-essay`,                          lastModified: new Date("2026-05-06"), changeFrequency: "monthly", priority: 0.8  },
    { url: `${SITE_URL}/notes/past-papers`,                           lastModified: new Date("2026-05-06"), changeFrequency: "monthly", priority: 0.75 },
