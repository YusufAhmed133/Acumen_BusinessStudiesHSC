...
export type McqQuestion = { id: string; topic: TopicKey; type: "mcq"; marks: number; src: string; stem: string; options: string[]; answer: number; explain: string; };
export type ShortQuestion = { id: string; topic: TopicKey; type: "short" | "extended"; marks: number; src: string; stem: string; criteria: string[]; sample: string; };
